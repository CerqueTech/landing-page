...
"digital-event-platform.md": {
	id: "digital-event-platform.md";
  slug: "digital-event-platform";
  body: string;
  collection: "portfolio";
  data: any
} & { render(): Render[".md"] };
"portfolio-example.md": {
	id: "portfolio-example.md";
  slug: "portfolio-example";
  body: string;
  collection: "portfolio";
  data: any
} & { render(): Render[".md"] };
"siempre-alerta.md": {
	id: "siempre-alerta.md";
  slug: "siempre-alerta";
  body: string;
  collection: "portfolio";
  data: any
...
"turnero-digital.md": {
	id: "turnero-digital.md";
  slug: "turnero-digital";
  body: string;
  collection: "portfolio";
  data: any
} & { render(): Render[".md"] };
